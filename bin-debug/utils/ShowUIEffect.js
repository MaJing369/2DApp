...
var ShowViewEffect = (function (_super) {
    ...
    p.showSceneEffect_1 = function () {
        ...
        this._dc.scaleX = 0.5;
        this._dc.scaleY = 0.5;
        this._dc.x = AppManager.LayerManager.stage.stageWidth / 4;
        this._dc.y = AppManager.LayerManager.stage.stageHeight / 4;
    ...
    p.showSceneEffect_3 = function () {
        this._dc.x = -AppManager.LayerManager.stage.stageWidth;
    ...
    p.showSceneEffect_5 = function () {
        this._dc.y = -AppManager.LayerManager.stage.stageHeight;
...
//# sourceMappingURL=ShowUIEffect.js.map